  ...
  <div className="w-full h-18 pb-1 bg-white fixed font-Cormorant border-b border-gray-300 || dark:bg-black/90 dark:md:bg-black/80 dark:border-gray-800">
      <div className='flex justify-between py-2 px-4 md:px-8'>
        <div>
          ...
          {/* <img src="../assets/image/LogoDark.svg" className="mt-2 h-10 w-10"  alt="" /> */}
          <div className="mt-2 h-10 w-10 bg-[url('../assets/image/LogoDark.svg')] || hover:dark:bg-[url('../assets/image/Logo.svg')] cursor-pointer" onClick={homeLink} />
        </div>
        ...
        <div className='flex gap-x-1'>
          ...
          <FiLogIn  className="text-black mt-4 md:mt-5 cursor-pointer text-[24px] md:text-sm || dark:text-white"/>
        </div>
      </div>
    </div>
  )
